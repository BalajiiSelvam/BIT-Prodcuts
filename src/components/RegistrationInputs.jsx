...
export default function RegistrationInputs() {
    ...
    Select.propTypes = {
      ...
      const blue = { 100: '#DAECFF', 200: '#99CCF3', 400: '#3399FF', 500: '#007FFF', 600: '#0072E5',
                     700: '#0059B2', 900: '#003A75' };
      const grey = { 50: '#F3F6F9', 100: '#E5EAF2', 200: '#DAE2ED', 300: '#C7D0DD', 400: '#B0B8C4',
                     500: '#9DA8B7', 600: '#6B7A90', 700: '#434D5B', 800: '#303740', 900: '#1C2025' };
      ...
      const StyledButton = styled(Button, { shouldForwardProp: () => true })(
        ...
        &:hover {
         border-color: ${theme.palette.mode === 'dark' ? grey[600] : grey[900]};
        }
    ...
    return (
        ...
        <Select defaultValue={5} 
            style={{ marginTop: '15px', height: '47px' }}>
            <Option value={5}>User Type</Option>
            <Option value={10}>Student</Option>
            <Option value={20}>Faculty</Option>
            <Option value={30}>Expert Team</Option>
